...
CREATE TABLE service_history(
    ...
    FOREIGN KEY (car_id) REFERENCES customer(customer_id) ON DELETE CASCADE,
...
ALTER TABLE invoice
ADD FOREIGN KEY (salesperson_id) REFERNCES salesperson(salesperson_id) ON DELETE CASCADE,
...
CREATE TABLE service_ticket(
	service_ticket_id SERIAL PROIMARY KEY,
	Service_history_id INTEGER NOT NULL,
	price NUMERIC(8,2) NOT NULL,
	service VARCHAR(50) NOT NULL,
	service_date DATE DEFAULT CURRENT_DATE,
	FOREIGN KEY (service_history_id) REFERENCES services_history(service_history) ON DELETE CASCADE
);
