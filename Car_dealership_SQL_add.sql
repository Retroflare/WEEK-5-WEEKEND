...
SELECT add_salesperson('Eagan', 'Obeien');
SELECT add_salesperson('John', 'Edwards');
SELECT add_salesperson('Chin', 'Ellis');

SELECT add_mechanic('Usain', 'Bolt');
SELECT add_mechanic('Shericka', 'Jackson');
SELECT add_mechanic('Mark ', 'Wallis');
SELECT add_mechanic('Donavon', 'Watkiss');

SELECT add_customer('Tajay', 'Campbell', 'IL11-1111-1111', 815);
SELECT add_customer('Berri', 'Camp', 'IL11-1111-2222', 829);
SELECT add_customer('Micheal', 'Frater', 'IL11-1111-3333', 817);

SELECT add_car(2023, 'Toyota', 'Mark ii', 'White', 100000.00, 'New');
SELECT add_car(2016, 'Honda', 'STI', 'Gray', 21000.00, 'New');
SELECT add_car(2012, 'Subaru', 'Impreza', 'Silver', 16000.00, 'New');
SELECT add_car(2022, 'Audi', 'Q7', 'White', 42000.00, 'New');
...
SELECT add_service_ticket(3, 300.00, 'Wheels Bearings Replacement', DATE '2019-07-29');
